        ...
        <main className="flex flex-col lg:flex-row gap-8">
          <div className="w-full lg:w-2/3">
            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <button 
                onClick={() => navigate("/")}
                className="bg-gray-800 hover:bg-gray-700 text-gray-300 py-2 px-4 rounded-lg transition-colors"
              >
              ...
              <div className="bg-gray-800 rounded-xl p-6 mb-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Level {user.level} • {user.coins} Coins</p>
                    <div className="flex items-center mt-1">
                      <div className="flex mr-4">
                        ...
                        <span className="text-xs">{user.stats.questionsAnswered} Questions</span>
                      </div>
                      <div className="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-400 mr-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
                        </svg>
                        <span className="text-xs">{user.stats.highestStreak} Best Streak</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-900 p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-blue-400 mb-2">Game Tips</h3>
